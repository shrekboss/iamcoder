...
import org.coder.concurrency.programming.juc.atomic.internal.*;
...
public class AtomicIntegerFieldUpdaterTest {
	...
	/**
	 * Class Alex所属的包为 org.coder.concurrency.programming.juc.atomic.internal.Alex3，
	 * 而是单元测试所属的包为 org.coder.concurrency.programming.juc.atomic，也就是说在单元测试中是无法直接访问Alex类中的salary属性的，
	 * 因此其不支持原子性更新。
	 */
