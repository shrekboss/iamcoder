 ...
 *
 * @SuppressWarnings("unchecked") private <T extends Metric> SortedMap<String, T> getMetrics(Class<T> klass, MetricFilter filter) {
 ...
 * @Override public Timer newMetric(){
 ...
 * @Override public Counter newMetric() {
 * return new Counter();
 * }
 * @Override public boolean isInstance(Metric metric) {
 ...
 * @Override public Histogram newMetric() {
 ...
 * @Override public Meter newMetric() {
 * return new Meter();
 * }
 * @Override public boolean isInstance(Metric metric) {
