...
//        System.out.println("=============华丽的分割线=============");
    ...
    public static void testMultithreaded() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            new Thread(() -> {
                RegisterSingleton singleton = RegisterSingleton.getInstance("org.coder.design.patterns._4_design_patterns.creation._1_singleton._template_code.register.RegisterSingleton");
