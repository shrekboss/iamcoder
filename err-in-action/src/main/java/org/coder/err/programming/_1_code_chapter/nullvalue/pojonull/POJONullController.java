...
public class POJONullController {
    ...
    // step1: init.sql
    // step2: curl -H "Content-Type:application/json" -X POST -d '{ "id":1, "name":null}' http://localhost:45678/pojonull/wrong {"id":1,"name":null,"nickname":"guestnull","age":null,"createDate":"2020-01-05T02:01:03.784+0000"}%
    @PostMapping("wrong")
