explain select * from person where NAME >'name84059' and create_time>'2024-07-23 00:00:00';
explain select * from person where NAME >'name84059' and create_time>'2024-07-23 00:00:00';
...
# 强制使用索引
EXPLAIN SELECT * FROM person FORCE INDEX(name_score) WHERE NAME >'name84059' AND create_time>'2024-07-23 05:00:00';
